// 仮データ（プロトタイプ用のサンプル値。正式な統計値ではない）。
// 将来は Airtable(topics / entries) からの同期スクリプトが生成する想定。
window.RANKING_DATA = {
  categories: [
  ...
  topics: [
    {
      ...
      periods: [
        { period: '2024', entries: [
          { name: '北海道', value: 850000 },
          { name: '長崎県', value: 320000 },
          { name: '茨城県', value: 280000 },
          { name: '静岡県', value: 210000 },
          { name: '宮城県', value: 180000 },
          { name: '三重県', value: 165000 },
          { name: '千葉県', value: 150000 },
          { name: '愛媛県', value: 140000 },
          { name: '島根県', value: 130000 },
          { name: '福岡県', value: 120000 },
        ]},
        { period: '2025', entries: [
          { name: '北海道', value: 810000 },
          { name: '長崎県', value: 340000 },
          { name: '茨城県', value: 275000 },
          { name: '静岡県', value: 205000 },
          { name: '三重県', value: 190000 },
          { name: '宮城県', value: 175000 },
          { name: '千葉県', value: 155000 },
          { name: '島根県', value: 138000 },
          { name: '愛媛県', value: 132000 },
          { name: '鹿児島県', value: 125000 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: '2024', entries: [
          { name: '中国', value: 180000 },
          { name: '米国', value: 175000 },
          { name: '韓国', value: 62000 },
          { name: '台湾', value: 58000 },
          { name: '香港', value: 42000 },
          { name: 'タイ', value: 38000 },
          { name: 'ドイツ', value: 25000 },
          { name: 'シンガポール', value: 24000 },
          { name: 'ベトナム', value: 22000 },
          { name: 'オーストラリア', value: 20000 },
        ]},
        { period: '2025', entries: [
          { name: '米国', value: 190000 },
          { name: '中国', value: 170000 },
          { name: '台湾', value: 63000 },
          { name: '韓国', value: 60000 },
          { name: '香港', value: 44000 },
          { name: 'タイ', value: 40000 },
          { name: 'ベトナム', value: 26000 },
          { name: 'ドイツ', value: 24000 },
          { name: 'シンガポール', value: 23000 },
          { name: 'オーストラリア', value: 21000 },
        ]},
      ],
    },
    {
    ...
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: 'エベレスト', value: 8849 },
          { name: 'K2', value: 8611 },
          { name: 'カンチェンジュンガ', value: 8586 },
          { name: 'ローツェ', value: 8516 },
          { name: 'マカルー', value: 8485 },
          { name: 'チョー・オユー', value: 8188 },
          { name: 'ダウラギリI峰', value: 8167 },
          { name: 'マナスル', value: 8163 },
          { name: 'ナンガ・パルバット', value: 8126 },
          { name: 'アンナプルナI峰', value: 8091 },
          { name: 'ガッシャーブルムI峰', value: 8080 },
          { name: 'ブロード・ピーク', value: 8051 },
          { name: 'ガッシャーブルムII峰', value: 8035 },
          { name: 'シシャパンマ', value: 8027 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: '富士山', value: 3776 },
          { name: '北岳', value: 3193 },
          { name: '奥穂高岳', value: 3190 },
          { name: '間ノ岳', value: 3190 },
          { name: '槍ヶ岳', value: 3180 },
          { name: '悪沢岳', value: 3141 },
          { name: '赤石岳', value: 3121 },
          { name: '涸沢岳', value: 3110 },
          { name: '北穂高岳', value: 3106 },
          { name: '大喰岳', value: 3101 },
          { name: '前穂高岳', value: 3090 },
          { name: '中岳（北アルプス）', value: 3084 },
          { name: '中岳（荒川中岳）', value: 3084 },
          { name: '御嶽山', value: 3067 },
          { name: '農鳥岳', value: 3051 },
          { name: '塩見岳', value: 3047 },
          { name: '南岳', value: 3033 },
          { name: '仙丈ヶ岳', value: 3033 },
          { name: '乗鞍岳', value: 3026 },
          { name: '立山', value: 3015 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: 'ロシア', value: 17098242 },
          { name: 'カナダ', value: 9984670 },
          { name: 'アメリカ', value: 9833517 },
          { name: '中国', value: 9596961 },
          { name: 'ブラジル', value: 8515767 },
          { name: 'オーストラリア', value: 7692024 },
          { name: 'インド', value: 3287263 },
          { name: 'アルゼンチン', value: 2780400 },
          { name: 'カザフスタン', value: 2724900 },
          { name: 'アルジェリア', value: 2381741 },
          { name: 'コンゴ民主共和国', value: 2389986 },
          { name: 'サウジアラビア', value: 2149690 },
          { name: 'メキシコ', value: 1964375 },
          { name: 'インドネシア', value: 1904569 },
          { name: 'スーダン', value: 1861484 },
          { name: 'リビア', value: 1759540 },
          { name: 'イラン', value: 1628750 },
          { name: 'モンゴル', value: 1564116 },
          { name: 'ペルー', value: 1285216 },
          { name: 'チャド', value: 1284000 },
          { name: 'ニジェール', value: 1267000 },
          { name: 'アンゴラ', value: 1246700 },
          { name: 'マリ', value: 1240192 },
          { name: '南アフリカ共和国', value: 1221037 },
          { name: 'コロンビア', value: 1141748 },
          { name: 'エチオピア', value: 1104300 },
          { name: 'ボリビア', value: 1098581 },
          { name: 'モーリタニア', value: 1030700 },
          { name: 'エジプト', value: 1001450 },
          { name: 'タンザニア', value: 945087 },
          { name: 'ナイジェリア', value: 923768 },
          { name: 'ベネズエラ', value: 916445 },
          { name: 'パキスタン', value: 881913 },
          { name: 'ナミビア', value: 824268 },
          { name: 'モザンビーク', value: 801590 },
          { name: 'トルコ', value: 783562 },
          { name: 'チリ', value: 756102 },
          { name: 'ザンビア', value: 752612 },
          { name: 'ミャンマー', value: 676886 },
          { name: 'アフガニスタン', value: 652864 },
          { name: '南スーダン', value: 644329 },
          { name: 'ソマリア', value: 637657 },
          { name: '中央アフリカ共和国', value: 622984 },
          { name: 'ウクライナ', value: 603500 },
          { name: 'マダガスカル', value: 587295 },
          { name: 'ボツワナ', value: 582000 },
          { name: 'ケニア', value: 581313 },
          { name: 'フランス', value: 551500 },
          { name: 'イエメン', value: 527968 },
          { name: 'タイ', value: 513120 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: null, entries: [
          ...
          { name: '秋田県', value: 11638 },
          { name: '岐阜県', value: 10621 },
          { name: '青森県', value: 9646 },
          { name: '山形県', value: 9323 },
          { name: '鹿児島県', value: 9186 },
          { name: '広島県', value: 8478 },
          { name: '兵庫県', value: 8401 },
          { name: '静岡県', value: 7777 },
          { name: '宮崎県', value: 7734 },
    ...
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: 'カスピ海', value: 374000 },
          { name: 'スペリオル湖', value: 82400 },
          { name: 'ビクトリア湖', value: 68800 },
          { name: 'ヒューロン湖', value: 59600 },
          { name: 'ミシガン湖', value: 57800 },
          { name: 'タンガニーカ湖', value: 32900 },
          { name: 'バイカル湖', value: 31500 },
          { name: 'グレートベア湖', value: 31000 },
          { name: 'マラウイ湖', value: 29600 },
          { name: 'グレートスレーブ湖', value: 27200 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: 'グリーンランド', value: 2166000 },
          { name: 'ニューギニア島', value: 785753 },
          { name: 'ボルネオ島', value: 743330 },
          { name: 'マダガスカル島', value: 587041 },
          { name: 'バフィン島', value: 507451 },
          { name: 'スマトラ島', value: 473481 },
          { name: '本州（日本）', value: 227970 },
          { name: 'ヴィクトリア島', value: 217291 },
          { name: 'グレートブリテン島', value: 209331 },
          { name: 'エルズミーア島', value: 196236 },
          { name: 'スラウェシ島', value: 174600 },
          { name: '南島（ニュージーランド）', value: 151215 },
          { name: 'ジャワ島', value: 126700 },
          { name: '北島（ニュージーランド）', value: 113729 },
          { name: 'ニューファンドランド島', value: 111390 },
          { name: 'キューバ島', value: 105007 },
          { name: 'ルソン島', value: 104688 },
          { name: 'アイスランド島', value: 102828 },
          { name: 'ミンダナオ島', value: 94630 },
          { name: 'アイルランド島', value: 84406 },
          { name: '北海道', value: 78073 },
          { name: '樺太', value: 76400 },
          { name: 'イスパニョーラ島', value: 74700 },
          { name: 'バンクス島', value: 70028 },
          { name: 'セイロン島', value: 65268 },
          { name: 'タスマニア島', value: 60637 },
          { name: 'デヴォン島', value: 55247 },
          { name: 'セヴェルヌィ島', value: 48904 },
          { name: 'フエゴ島', value: 47992 },
          { name: 'バークナー島', value: 43873 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: null, entries: [
          { name: 'ブルジュ・ハリファ', value: 828 },
          { name: 'メルデカ118', value: 679 },
          { name: '上海中心大厦', value: 632 },
          { name: 'アブラージュ・アル・バイト時計塔', value: 601 },
          { name: '平安国際金融中心', value: 599 },
          { name: '高銀金融117', value: 597 },
          { name: 'ロッテワールドタワー', value: 555 },
          { name: 'ワン・ワールドトレードセンター', value: 541 },
          { name: '広州周大福金融中心', value: 530 },
          { name: '天津周大福金融中心', value: 530 },
        ]},
      ],
    },
    {
      ...
      periods: [
        { period: '2024', entries: [
          { name: '名探偵コナン最新作', value: 140 },
          { name: 'ハリー・ポッターシリーズ再上映', value: 90 },
          { name: '劇場版アニメA', value: 85 },
          { name: 'ゴジラ最新作', value: 80 },
          { name: '実写邦画A', value: 60 },
          { name: 'ディズニーアニメ最新作', value: 55 },
          { name: '劇場版アニメB', value: 50 },
          { name: 'マーベル最新作', value: 48 },
          { name: '実写邦画B', value: 40 },
          { name: '劇場版アニメC', value: 35 },
        ]},
        { period: '2025', entries: [
          { name: '劇場版アニメD', value: 155 },
          { name: '名探偵コナン最新作', value: 130 },
          { name: '劇場版アニメE', value: 95 },
          { name: 'ゴジラ最新作', value: 70 },
          { name: 'ハリー・ポッターシリーズ再上映', value: 65 },
          { name: 'ディズニーアニメ最新作', value: 58 },
          { name: '実写邦画C', value: 50 },
          { name: 'マーベル最新作', value: 45 },
          { name: '劇場版アニメF', value: 42 },
          { name: '実写邦画D', value: 38 },
        ]},
      ],
    },
