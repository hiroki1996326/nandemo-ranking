          ...
          'entries': [
            {
              'name': '北海道',
              'value': 850981,
              'note': '広い海域を持ち、都道府県別漁獲量で全国1位。2023年漁業センサスによると、北海道の漁船隻数は17,068隻で全国の総隻数（109,283隻）の約15.6%を占め、隻数でも都道府県別で全国最多。',
            },
            {
              'name': '茨城県',
              'value': 285164,
            ...
            },
            {
              'name': '長崎県',
              'value': 262233,
              'note': '複雑な海岸線を持つ好漁場が多く、漁獲量は全国2位。水揚げされる魚種は300種以上で全国最多とされ、2019年にはマアジ（全国シェア42.1%）・サバ類（同15.9%）がいずれも漁獲量日本一だった。',
            },
          ],
        },
        {
