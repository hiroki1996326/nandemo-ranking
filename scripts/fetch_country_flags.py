...
COUNTRY_ISO = {
    ...
    'ベルギー': 'be', 'エストニア': 'ee', 'デンマーク': 'dk', 'ラトビア': 'lv',
    'ボスニア・ヘルツェゴビナ': 'ba', 'クロアチア': 'hr', 'セルビア': 'rs',
    'チェコ': 'cz', 'スロベニア': 'si', 'フィンランド': 'fi', 'スロバキア': 'sk',
    'リトアニア': 'lt', 'アイルランド': 'ie',
    'イラク': 'iq', 'アラブ首長国連邦': 'ae', 'クウェート': 'kw',
    'ギリシャ': 'gr', 'トルコ': 'tr',
    'ポーランド': 'pl', 'ポルトガル': 'pt', 'ウズベキスタン': 'uz',
    'イスラエル': 'il', 'カタール': 'qa', 'ルーマニア': 'ro', 'ニュージーランド': 'nz',
    'フィリピン': 'ph', 'カンボジア': 'kh', 'ネパール': 'np', 'スリランカ': 'lk',
    'パラグアイ': 'py', 'ベナン': 'bj', 'コートジボワール': 'ci', 'ガーナ': 'gh',
    'エクアドル': 'ec', 'カメルーン': 'cm', 'シエラレオネ': 'sl', 'ドミニカ共和国': 'do',
    'パプアニューギニア': 'pg', 'ウガンダ': 'ug',
    'マリ': 'ml', 'アフガニスタン': 'af', 'ホンジュラス': 'hn',
}
